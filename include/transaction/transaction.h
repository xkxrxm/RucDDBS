...
public:
    ...
    void add_modify(Modify m) { writes_->push_back(m); }
    ...
    inline uint64_t get_start_time() const { return start_time; }
    ...
    inline rw_set *get_write_set() { return write_set_; }
    inline rw_set *&get_read_set() { return read_set_; }
