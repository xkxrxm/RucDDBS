...
{
public:
    TransactionManagerImpl(TransactionManager *transaction_manager)
        ...
        ::google::protobuf::Closure *done)
    {
        ...
        //     return;
        // }
        transaction_manager_->AbortSingle(txn, false);
        ...
        ::google::protobuf::Closure *done)
    {
        ...
        // // txn->set_coor_ip({request->coor_ip().ip_addr(),
        // request->coor_ip().port()});
        // // fault_tolerance: 设置参与者节点上的所有参与者节点
        // // for(int i=0; i<request->ips_size(); i++){
        // //     IP_Port t{request->ips()[i].ip_addr(),
        // request->ips()[i].port()};
