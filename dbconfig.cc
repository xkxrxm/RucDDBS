...
DEFINE_int32(SERVER_LISTEN_PORT, 8005, "TCP Port of server");
DEFINE_string(SERVER_LISTEN_ADDR,
              "0.0.0.0",
              "Server listen address, may be IPV4/IPV6/UDS."
              " If this is set, the flag port will be ignored");

// config for log path
DEFINE_string(log_path, "/home/xkx/ruc_workspace/RucDDBS2/data/", "log path");